def print_args(args):
    ...
    print(f'  {"Step:":<20}{args.step:<20}{"Seq Len:":<20}{args.seq_len:<20}')
    print(f'  {"Num Classes:":<20}{args.num_class:<20}{"Checkpoints:":<20}{args.checkpoints:<20}')
    print()
    ...
    print(f'  {"Factor:":<20}{args.factor:<20}{"Dropout:":<20}{args.dropout:<20}')
